...
class _ProjectCustomizationScreenState
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => ChallengeMindScreen(
            projects: _projects,
            fromTabIndex: widget.fromTabIndex,
            onNavigateBack: () {
  ...
  Widget _buildProjectCardWithActions(Project project, bool isSelected) {
    return AnimatedContainer(
      ...
      height: isSelected ? 360 : 300, // Altura fixa: cresce quando selecionado
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
  ...
  Widget _buildResponsiveProjectGrid() {
    ...
    if (isDesktop) {
      crossAxisCount = _selectedProject != null ? 2 : 3;
      childAspectRatio = _selectedProject != null ? 1.2 : 1.0;
    } else if (isTablet) {
      crossAxisCount = _selectedProject != null ? 1 : 2;
      childAspectRatio = _selectedProject != null ? 1.4 : 1.2;
    } else {
      crossAxisCount = 1;
      childAspectRatio = _selectedProject != null ? 1.3 : 1.1;
    }
    ...
    return GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        ...
        childAspectRatio: 0.8, // Proporção fixa para evitar problemas de layout
        crossAxisSpacing: 16,
        mainAxisSpacing: 20, // Espaçamento maior para acomodar cards selecionados
      ),
