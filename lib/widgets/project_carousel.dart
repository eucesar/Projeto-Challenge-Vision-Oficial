...
class _ProjectCarouselState extends State<ProjectCarousel> {
  ...
  void initState() {
    ...
    // Auto-scroll desativado - cards não passam sozinhos
    // _startAutoScroll();
  }
  ...
  void didUpdateWidget(ProjectCarousel oldWidget) {
    ...
    // Auto-scroll desativado - não reinicia automaticamente
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        SizedBox(
          height: isDesktop ? null : 400, // Altura aumentada para mobile/tablet
